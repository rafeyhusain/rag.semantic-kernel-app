namespace Rag.SemanticKernel.Template.Handlebar;
...
public class TemplateFile
{
    ...
    public void Load()
    {
        ...
        Prompt = yamlData.TryGetValue("prompt", out var q) ? q :
            throw new InvalidDataException("Missing 'prompt' in YAML front matter.");
    }
}