...
public class SemanticService
{
    ...
    {
        var endpoint = _configuration["Mistral:Endpoint"];
        var apiKey = _configuration["Mistral:ApiKey"];
        var completionModel = _configuration["Mistral:CompletionModel"];
        var embeddingModel = _configuration["Mistral:EmbeddingModel"];
